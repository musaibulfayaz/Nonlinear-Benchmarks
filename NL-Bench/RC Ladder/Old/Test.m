...
optionsFOMNLJac = odeset('RelTol',1e-6,'AbsTol',1e-9, 'Jacobian', Jac);
tic
[~,xNLJac] = ode15s(xdotNL,tSim,x0NL,optionsFOMNLJac);
simTimeFOMNL = toc
yNLJac = C*xNLJac';
...
xlabel('Time (s)');
ylabel('Output y');
legend('NL-FOM without Jac', 'NL-FOM with Jac');
